...
export type CheckMaxPageSizeQueryVariables = Exact<{ [key: string]: never; }>;


export type CheckMaxPageSizeQuery = { __typename?: 'Query', serviceConfig: { __typename?: 'ServiceConfig', maxPageSize?: number | null } };

export type GetNftsByTypeQueryVariables = Exact<{
  nftType: Scalars['String']['input'];
  first?: InputMaybe<Scalars['Int']['input']>;
  after?: InputMaybe<Scalars['String']['input']>;
}>;


export type GetNftsByTypeQuery = { __typename?: 'Query', objects?: { __typename?: 'ObjectConnection', pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, endCursor?: string | null }, nodes: Array<{ __typename?: 'Object', address: any, asMoveObject?: { __typename?: 'MoveObject', contents?: { __typename?: 'MoveValue', json?: any | null, display?: { __typename?: 'Display', output?: any | null } | null } | null } | null }> } | null };


export const CheckMaxPageSizeDocument = gql`
    query checkMaxPageSize {
  serviceConfig {
    maxPageSize(type: "Query", field: "objects")
  }
}
    `;
export const GetNftsByTypeDocument = gql`
    query GetNftsByType($nftType: String!, $first: Int, $after: String) {
  objects(first: $first, after: $after, filter: {type: $nftType}) {
    pageInfo {
      hasNextPage
      endCursor
    }
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    checkMaxPageSize(variables?: CheckMaxPageSizeQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CheckMaxPageSizeQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<CheckMaxPageSizeQuery>({ document: CheckMaxPageSizeDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'checkMaxPageSize', 'query', variables);
    },
    GetNftsByType(variables: GetNftsByTypeQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetNftsByTypeQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetNftsByTypeQuery>({ document: GetNftsByTypeDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetNftsByType', 'query', variables);
    }
  };
}
